...
function Contact() {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "ce3562ba-8d44-43b5-a714-01190f17f3ab");
    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 className="uppercase mb-4 text-4xl tracking-tight font-bold text-center text-brickred dark:text-white">keep in touch</h2>
                ...
                <form onSubmit={onSubmit} className="space-y-8">
                    ...
                    <button type="submit" onClick={notify}  className="active:bg-grayishblue focus:outline-none focus:ring focus:ring-grey py-3 px-5 text-sm font-medium text-center text-white rounded-lg sm:w-fit bg-brickred ">Send message</button>
                    <ToastContainer/>
                </form>
