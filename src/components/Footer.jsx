    ...
    <>
      <div className='h-[100%] w-full bg-footerbg bg-cover bg-center bg-no-repeat pb-10'>
        <div className='text-center gap-y-5 flex flex-col justify-center items-center text-white  '>
          ...
          <button className='hover:translate-y-2 transition-all duration-500  focus:ring focus:ring-white focus:white bg-brickred text-white px-8 py-4 mb:10 lg:mb-20'>start free trial</button>
        </div>

      </div>
      <div className='bg-blackc w-full flex flex-col justify-center gap-y-5 lg:gap-y-0 lg:flex-row lg:justify-start items-center p-5'>
        <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
          <a href="#" class="text-white hover:text-grey dark:hover:text-white">
        ...
        <div className='lg:ml-auto text-white '>Made By <span className='font-bold text-brickred'>Abed</span>. </div>
      </div>
    </>
